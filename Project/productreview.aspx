    ...
    <div class="row">
        ...
        <div id="AddReviewSection" class="productreviews col-12 column" runat="server">
            ...
            <asp:Button ID="btn_SubmitReview" CssClass="acceptbutton" runat="server" Text="Plaats Review" OnClick="btn_SubmitReview_Click" />
                        <br />
            <p><asp:Label ID="lbl_errormessage" CssClass="errormessage" runat="server" Text="*Je samenvatting en/of beoordeling is niet ingevuld terwijl deze verplicht zijn!" Visible="False"></asp:Label></p>
        </div>
        ...
        <div id="AddCommentSection" class="newcomment col-8 column" runat="server">
            ...
            <br />
            <asp:Button ID="btn_SendComment" CssClass="acceptbutton" runat="server" Text="Plaats Reactie" />
